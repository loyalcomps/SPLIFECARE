...
class CAREGIVER_salary_statementXls(models.AbstractModel):
    _name = 'report.caregiver_salary_statement_report.caregiver_xls'
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.merge_range('B6:B7', "NAME OF CARE GIVERS", title_style)
        ...
        sheet.write_string('H7', "TDS", title_style)
        sheet.write_string('I7', "ADVANCE", title_style)
