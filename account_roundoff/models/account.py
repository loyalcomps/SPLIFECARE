...
class ResConfigSettings(models.TransientModel):
    ...
    roundoff_account_id = fields.Many2one('account.account', string='Roundoff Account', implied_group='account.roundoff_account_id',related='company_id.roundoff_account_id',readonly=False,store=True)
